...
public class CSMovie {
    ...
    public String toString() {
        return "CSMovie [title=" + title + ", rating=" + rating + ", genre=" + genre + ", year=" + year + ", score="
                + score + ", votes=" + votes + ", director=" + director + ", star=" + star + ", country=" + country
                + ", budget=" + budget + ", gross=" + gross + ", company=" + company + ", runtime=" + runtime + "]";
    }
